...
public class KartMovement : MonoBehaviour
{
    ...
    private void Update()
    {
        // MODIFICACI�N: L�gica unificada para enviar eventos de animaci�n
        if (isTackling)
        {
            // Durante tackleada: enviar valores simulados para mantener animaci�n
        ...
        {
            // Cuando el input est� deshabilitado, forzar valores cero para animaciones
    ...
    private void FixedUpdate()
    {
        ...
        {
            HandleMovement();
            // MODIFICACI�N: Solo aplicar steering si no est� haciendo tackleada
            if (!isTackling)
            {
                HandleSteering();
            }
    ...
    {
        // MODIFICACI�N: No actualizar boost durante tackleada
    ...
    private void HandleVisualRotations()
    {
        ...
        // MODIFICACI�N: Durante tackleada, mantener rotaci�n neutral
    ...
    {
        // MODIFICADO: El límite también respeta el multiplicador externo
        float currentMaxSpeed = (isBoosted ? kartStats.boostedMaxSpeed : kartStats.maxSpeed) * externalSpeedMultiplier;
    ...
    // M�todos para controlar el input
    ...
    // NUEVO M�TODO: Para controlar estado de tackleada
